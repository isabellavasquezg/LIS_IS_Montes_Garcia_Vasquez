...
.tabla-menu-sujetos tbody tr {
  display: table-row;
  box-shadow: 0 2px 6px rgba(11, 95, 165, 0.04);
...
.tabla-menu-sujetos tbody tr:hover {
...
.tabla-menu-sujetos tbody tr:nth-child(even) {
  background: #fbfdff;
}
