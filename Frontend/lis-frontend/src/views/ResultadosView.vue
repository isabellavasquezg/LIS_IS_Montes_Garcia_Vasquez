...
.imagen-logo-menu{ margin-top: 40px; height: 120px; width: 140px; background-image: url("../../public/images/logo_menu.png"); background-size: cover; }
.usuario-name-menu{ color:#ffffff; font-family: sans-serif; margin-top: 30px; font-size: 20px; }
.menu-opciones-contenedor{ margin: 40px 0; padding-left: 10px; width: 100%; box-sizing: border-box; }
.menu-opcion{ list-style-type: none; margin: 20px 0; box-sizing: border-box; font-family: sans-serif; color: #ffffff; font-weight: bold; font-size: 20px; padding: 18px 0; padding-left: 14px; border-radius: 15px 0 0 15px; cursor: pointer; display: flex; align-items: center; gap: 10px; }
.menu-opcion:hover{ background-color: #117fb9 }
.menu-opcion svg { width: 28px; height: 28px; }
...
.icon-btn svg{ display:block; width:26px; height:26px; }
...
.tabla-menu-sujetos{ border-collapse: separate; border-spacing: 0 12px; width: 120%; font-family: sans-serif; font-size: 16px }
